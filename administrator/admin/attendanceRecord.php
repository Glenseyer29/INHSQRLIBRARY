            ...
            <section class="content">
              ...
              <tbody>
                <?php
                  ...
                  $sql = "SELECT * FROM studattendance";
                      ...
                      while ($row = $query->fetch_assoc()) {
                          ...
                          <tr>
                              ...
                              <form method="POST" action="admin.php?action=delete" style="display:inline">
                                ...
                                <button type="submit" name="delete" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#confirmDelete" data-title="Confirm Delete" data-message="Are you sure you want to delete this?">
