<?php
if (Input::exists()) {
	$transaction = DB::getInstance()->delete('data', array('id', '=', Input::get('id')));
	Session::flash('Deleted', 'Message has been successfully deleted.');
	Redirect::to('admin.php?action=inbox');
}
?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Library Message History</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Library Message History</h3>
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover" id="articles">
                                        ...
                                        <tbody>
											<?php
												$data = DB:: getInstance()->query("SELECT * FROM data");
