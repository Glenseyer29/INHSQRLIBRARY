	...
	if($user->isSuperAdmin()) {
      ...
      case 'editAttendance':
        ...
        break;
			...
			case 'listQrStudents':
				require('admin/listQrStudents.php');
			break;

			case 'addQrStudents':
				require('admin/addQrStudents.php');
			break;

			case 'deleteQrStudent':
				require('admin/deleteQrStudent.php');
			break;

			case 'editQrStudents':
				require('admin/editQrStudents.php');
			break;
      case 'forum':
        require('admin/forum.php');
      break;
      case 'inbox':
        require('admin/inbox.php');
      break;
      case 'saveToForum':
