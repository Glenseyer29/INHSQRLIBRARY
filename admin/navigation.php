            ...
            <aside class="left-side sidebar-offcanvas">
				...
				<?php if($user->isTeacher()) {?>
					<ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-home"></i> <span>Iba National High School</span>
                            </a>
                        </li>
                    </ul>
				<?php }?>
				...
				<?php if($user->isLibraryAdmin()) {?>
					<ul class="sidebar-menu">
                        ...
                        <li class="active">
                            <a href="admin.php?action=contact">
                                <i class="fas fa-comments"></i>  <span>Message Us</span>
                            </a>
                        </li>
                        <li class="active">
                            <a href="admin.php?action=forum">
                                <i class="fas fa-comments"></i>  <span>Start Forum</span>
                            </a>
                        </li>
						<li class="treeview">
                            <a href="#">
